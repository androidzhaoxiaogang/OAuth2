...
import it.seiton.oauth2.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("it.seiton.oauth2.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("it.seiton.oauth2.repository.search")
