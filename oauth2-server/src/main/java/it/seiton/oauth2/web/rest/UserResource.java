package it.seiton.oauth2.web.rest;

import com.codahale.metrics.annotation.Timed;
import it.seiton.oauth2.domain.Authority;
import it.seiton.oauth2.domain.User;
import it.seiton.oauth2.repository.AuthorityRepository;
import it.seiton.oauth2.repository.UserRepository;
import it.seiton.oauth2.repository.search.UserSearchRepository;
import it.seiton.oauth2.security.AuthoritiesConstants;
import it.seiton.oauth2.service.MailService;
import it.seiton.oauth2.service.UserService;
import it.seiton.oauth2.web.rest.dto.ManagedUserDTO;
import it.seiton.oauth2.web.rest.dto.UserDTO;
import it.seiton.oauth2.web.rest.util.HeaderUtil;
import it.seiton.oauth2.web.rest.util.PaginationUtil;
