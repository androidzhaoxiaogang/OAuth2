package it.seiton.oauth2.web.websocket;

import it.seiton.oauth2.security.SecurityUtils;
import it.seiton.oauth2.web.websocket.dto.ActivityDTO;
...
import static it.seiton.oauth2.config.WebsocketConfiguration.IP_ADDRESS;
