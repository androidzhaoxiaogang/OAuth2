...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        Oauth2App app = Oauth2App.get(this);

        component = DaggerMainActivityComponent
                .builder()
                .oauth2Component(app.component())
                .build();
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.main_content, loginFragment, loginFragment.fragmentTag())
                    .commit()
            ;
        }
        // ATTENTION: This was auto-generated to implement the App Indexing API.
    ...
    public void replaceFragment(BaseFragment fragment) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.main_content, fragment, fragment.fragmentTag())
                .commit()
        ;
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://it.seiton.oauth2/http/host/path")
        );
    ...
    protected void onPause() {
        Log.i("Main Activity", "---> Main activity on pause");
        component = null;
        super.onPause();
    }
}
